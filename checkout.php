...
if($finishval == 'silver')
 $display = "1";
else if($finishval == 'gold')
 $display = "2";
else if($finishval == 'gray')
 $display = "3";
...
<body onload="return selected(<?php echo $display . ',' . $type; ?>);">
<div class="main">
<div class="header">
...
<div style="padding-bottom:50px;" class="content">
	...
	<div class="cart_options_image" id="iphone0" ><img src="./resources/iphones.png" /></div>
